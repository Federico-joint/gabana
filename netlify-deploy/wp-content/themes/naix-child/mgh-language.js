(function () {
  ...
  var htmlRules = [
    ...
    ['.home-sector-item:nth-of-type(3) .home-sector-panel__inner p:nth-of-type(1)', 'Le Pietrare is a real estate management company focused on leasing activities in the municipality of Viterbo, including offices, shops, storage areas, covered parking and service spaces.'],
    ['.home-sector-item:nth-of-type(3) .home-sector-panel__inner p:nth-of-type(2)', 'CCT 90 manages a leased real estate surface of about 3,200 sqm in the metropolitan city of Rome, mainly intended for commercial activities.'],
    ['.home-sector-item:nth-of-type(3) .home-sector-panel__inner p:nth-of-type(3)', 'Interlaghi owns the former Colonia Motta real estate complex in Verbania, made up of several buildings on land sloping down toward Lake Maggiore.'],
    ['.home-sector-item:nth-of-type(3) .home-sector-panel__inner p:nth-of-type(4)', 'Magazzini e Molini del Tirreno owns an industrial complex for cereal milling in the Lucca area, currently being assessed for production restart or real estate enhancement.'],
